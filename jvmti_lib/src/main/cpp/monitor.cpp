...
Java_com_lishuaihua_jvmti_Monitor_native_1init(JNIEnv *env, jclass jclazz, jstring _path) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_lishuaihua_jvmti_Monitor_native_1release(JNIEnv *env, jclass clazz) {
    if (memoryFile) {
        delete memoryFile;
        memoryFile = 0;
    }
